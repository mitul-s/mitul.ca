    ...
    <ScrollAreaPrimitive.Root type="always" className={className}>
      <ScrollAreaPrimitive.Viewport className="w-full h-full ">
        ...
        <ScrollAreaPrimitive.Scrollbar
          className="flex select-none -mb-2 w-[calc(100%-6px)] mx-auto rounded-md touch-none bg-gray-12 transition-colors duration-100 ease-out hover:bg-[white]/20 data-[orientation=horizontal]:flex-col data-[orientation=horizontal]:h-1"
