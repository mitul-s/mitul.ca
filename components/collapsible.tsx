...
export const ExpandingLink: React.FC<ExpandingLinkProps> = ({
  ...
  return (
    <motion.a
      className="cursor-pointer text-sm z-[2] flex items-center overflow-hidden hover:group-data-[state=open]:bg-accent hover:text-gray-1 h-4 transition-colors duration-100 ease-in opacity-0 group-data-[state=open]:opacity-100 group-data-[state=open]:text-accent group-hover:opacity-100 text-gray-1"
    ...
    >
      <ArrowUpRight aria-hidden={true} size={12} className="shrink-0 ml-0.5" />
